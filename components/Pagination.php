...
class Pagination
{
     ...
     *  type $total <p>Общее количество записей</p>
     *  type $currentPage <p>Номер текущей страницы</p>
     *  type $limit <p>Количество записей на страницу</p>
     *  type $index <p>Ключ для url</p>
     */
    ...
    public function get()
    {
        ...
        $html = '<div class="pages"><ul class="pagination">';
        # Генерируем ссылки
