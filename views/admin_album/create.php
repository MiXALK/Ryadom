...
<section>
    <div class="container">
        <div class="row">
            ...
            <h4><img src="/views/images/plus.png"/>Добавить новый альбом</h4>
            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <input type="text" name="gallery_name" placeholder="" value="">

                        <p>Ссылка на обложку</p>
                        <input class="largeInput" type="text" name="cover" placeholder="" value="">
